...
- Bounded PR bodies: `create_pr.sh` now sends a short 30,000-character summary body, keeps full reports in the `forgis-reports` artifact, and retries once with a 3,000-character minimal body if GitHub rejects the first body as too long.
