...
echo "  Aider command summary: aider --model <model> --message-file <forgis_prompt> --read <task_prompt> --read <config_if_present> --subtree-only --yes-always --no-auto-commits --no-show-release-notes <writable_scope_seed>"
