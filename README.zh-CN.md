...
- **`FORGIS_CONFIG.yml`：** repo ref、输出分支、输出子目录、任务文件路径、DeepSeek 连接字段、运行开关、skills、report、repair loop、migration plan 等通用运行配置。
...
- `agent_backend: aider`：v5.0 只支持 `agent_backend: deepseek`。
